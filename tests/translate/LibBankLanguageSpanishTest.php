...
// to run test: sail artisan test --filter LibBankLanguageSpanishTest
class LibBankLanguageSpanishTest extends TestCase
{
    /**
    ...
    // Caminhos para os arquivos de array em diferentes diretórios
	{
        ...
        $path = base_path() . '/vendor/codificar/bank/src/resources/lang';
