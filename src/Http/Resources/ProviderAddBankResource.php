...
use Finance, Bank;
/**
 * Class ProviderAddBankResource
 *
 * @package MotoboyApp
 *
 *
 * @OA\Schema(
 *         schema="ProviderAddBankResource",
 *         type="object",
 *         description="Adiciona um saque para o prestador",
 *         title="Bank Details Resource",
 *        allOf={
 *           @OA\Schema(ref="#/components/schemas/ProviderAddBankResource"),
 *           @OA\Schema(
 ...
 * )
 */
class ProviderAddBankResource extends JsonResource {
